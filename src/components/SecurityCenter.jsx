    ...
    <section className="security-center">
      <div className="security-hero">
        ...
        <div>
          ...
          <p>Os dados locais são tratados com validação, ocultação de apresentação e backup criptografado. Para operação multiusuário, autenticação e permissões devem ficar no servidor.</p>
        </div>
      </div>
      ...
      <div className="security-grid">
        ...
        <article className="security-card security-card--prevention">
          ...
          <ul className="prevention-list">
            ...
            <li><i /> Validação de armazenamento, extensão e backups</li>
